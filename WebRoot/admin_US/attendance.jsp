...
<html lang="en">
   ...
   <!-- BEGIN META -->
    ...
    <!-- BEGIN SHORTCUT ICON -->
	  ...
	  <!-- END SHORTCUT ICON -->
	  <title>Shandong University of Science and Technology Ji'nan campus student class attendance table query</title>
   ...
   <body onload="active(),setup()">
      ...
      <!-- START ROW -->
         ...
         <form action="Print_printFunction?page=attendance"  method="post">
