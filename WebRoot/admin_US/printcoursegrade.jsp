...
<body>
					...
					<table class="Font11PtX120" width="100%" cellspacing="0"
						...
						<tbody>
							<tr valign="middle" align="left">
				                ...
				                <td height="18" nowrap="nowrap" align="left">班号：${list.get(0).getClassId() } </td>
				                <td height="18" width="40%" nowrap="nowrap" align="left">学年学期：${list.get(0).getYears() }</td>
			           		</tr>
			            	<tr valign="middle" align="left">
				                <td height="18" nowrap="nowrap" align="left">课程名称：${list.get(0).getCourseName() }</td>
							...
							<tr valign="top" align="left">
								<td width="356">
									<table class="LUpLines" width="100%" cellspacing="0"
										cellpadding="0" border="1" align="left" style="border-right:none;border-left:none;border-bottom:none">
										<tbody>
											<tr class="Font11PtX120" valign="middle" align="center">
												<td height="18" class="RULine" width="5%" nowrap="nowrap" style="border-right:1px solid;border-left:1px solid;border-bottom:1px solid">序号</td>
												<td height="18" class="RULine" width="30%" nowrap="nowrap" style="border-right:1px solid;border-left:1px solid;border-bottom:1px solid"">学号</td>
												<td height="18" class="RULine" width="25%" nowrap="nowrap" style="border-right:1px solid;border-left:1px solid;border-bottom:1px solid"">姓名</td>
												<td height="18" class="RULine" width="25%" nowrap="nowrap" style="border-right:1px solid;border-left:1px solid;border-bottom:1px solid"">成绩</td>
												<td height="18" class="RULine" width="15%" nowrap="nowrap" style="border-right:1px solid;border-left:1px solid;border-bottom:1px solid"">备注</td>
											</tr>
											<c:choose>
												<c:when test="${list.size()<35}">
													...
													<tr class="Font8Pt" valign="top">
														<td height="21" class="RULine" align="center"
															valign="middle" style="border-right:1px solid;border-left:1px solid;border-bottom:1px solid""><font size="2">${status.count}</font></td>
														<td height="21" class="RULine" nowrap="nowrap"
															valign="middle" style="border-right:1px solid;border-left:1px solid;border-bottom:1px solid""><font size="2">${att.getSid() }</font></td>
														<td height="21" class="RULine" nowrap="nowrap"
															valign="middle" style="border-right:1px solid;border-left:1px solid;border-bottom:1px solid""><font size="2">${att.getSname() }</font></td>
														<td height="21" class="RULine" nowrap="nowrap"
															valign="middle" style="border-right:1px solid;border-left:1px solid;border-bottom:1px solid""><font size="2">&nbsp;</font></td>
														<td height="21" class="RULine" nowrap="nowrap"
															valign="middle" style="border-right:1px solid;border-left:1px solid;border-bottom:1px solid""><font size="2">&nbsp;</font></td>
													</tr>
													</c:forEach>
													<c:forEach  begin="${list.size()}" end="35"  var="att1"  varStatus="status" >
														<tr class="Font8Pt" valign="top" >
															<td height="21" class="RULine" align="center"
												...
												<c:otherwise>
													<c:forEach items="${list}" var="att"  begin="1" end="35"  varStatus="status" >
														<tr class="Font8Pt" valign="top">
														<td height="21" class="RULine" align="center"
															valign="middle" style="border-right:1px solid;border-left:1px solid;border-bottom:1px solid""><font size="2">${status.count}</font></td>
														<td height="21" class="RULine" nowrap="nowrap"
											...
											<tr valign="top" align="left">
												...
												<td width="356">
													<table class="LUpLines" width="100%" cellspacing="0"
														...
														<tbody>
															<tr class="Font11PtX120" valign="middle" align="center">
																<td height="18" class="RULine" width="5%" nowrap="nowrap">序号</td>
																<td height="18" class="RULine" width="30%" nowrap="nowrap">学号</td>
																<td height="18" class="RULine" width="25%" nowrap="nowrap">姓名</td>
																<td height="18" class="RULine" width="25%" nowrap="nowrap">成绩</td>
																<td height="18" class="RULine" width="15%" nowrap="nowrap">备注</td>
															</tr>
															
															<s:if test="%{list.size()>35}" >
																<c:forEach items="${list}" var="att" begin="35" end="${list.size()-1}" varStatus="status">
																	<tr class="Font8Pt" valign="top">
																		<td height="21"  class="RULine" align="center"><font size="2">${status.count+35}</font></td>
																		<td height="21" class="RULine" nowrap="nowrap"><font size="2">${att.getSid() }</font></td>
																		<td height="21" class="RULine" nowrap="nowrap"><font size="2">${att.getSname() }</font></td>
																		<td height="21" class="RULine" nowrap="nowrap"><font size="2">&nbsp;</font></td>
																		<td height="21" class="RULine" nowrap="nowrap"><font size="2">&nbsp;</font></td>
																	</tr>
																</c:forEach>
															</s:if>
	...
	<table id="tblMsg2" width="750" cellspacing="0" cellpadding="0"
		...
		<tbody>
			...
			<tr>
				<td width="5%">注：</td>
				<td>1、不及格成绩请用红笔登记，无成绩者应在“备注”栏中注明原因；成绩填写不能使用复写纸;</td>
</tr>
<tr>
				<td></td>
				<td>2、成绩如有涂改，或无任课教师签字，则此单无效；</td>
</tr>
<tr>
				<td></td>
				<td>3、此单由任课教师填写，一式两份，考试后四天内分别送教务科和学生所在院（系、部）办公室。</td>
</tr>
					
			</table>		
					
					<!--注：<p class="text-left"> 1、不及格成绩请用红笔登记，无成绩者应在“备注”栏中注明原因；成绩填写不能使用复写纸；-->
					<!--<br>2、成绩如有涂改，或无任课教师签字，则此单无效；--> <!--<br>3、此单由任课教师填写，一式两份，考试后四天内分别送教务科和学生所在院（系、部）办公室。</p>-->
			...
			<tr>
				...
				<table width="40%" border="0" align="center" valign="middle"
					...
					<tr>
						...
						<td><a href="coursegrade.jsp" style='text-decoration:none;'>
