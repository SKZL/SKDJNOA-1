		...
		<tbody>
			<tr>
				<td class="Font18" width="50%" valign="middle" align="center"><font
					size="5" face="黑体">山东科技大学学生课程成绩单</font> <br></td>
			</tr>
			<tr>
				<td>
										...
										<tbody>
											...
											<c:choose>
												<c:when test="${list.size()<35}">
													<c:forEach items="${list}" var="att" varStatus="status">
														<tr class="Font8Pt" valign="top">
															...
															<td height="21" class="RULine" nowrap="nowrap"
															   ...
															   <c:when test="${(String)att.getFinalGrade().toString()eq'优' } or ${att.getFinalGrade().toString()eq'良'} or ${att.getFinalGrade().toString()eq'中'} or ${att.getFinalGrade().toString()eq'及格'} or ${att.getFinalGrade().toString()eq'不及格'}">  
													...
													<c:forEach begin="${list.size()}" end="35" var="att1"
														varStatus="status">
														<tr class="Font8Pt" valign="top">
															<td height="21" class="RULine" align="center"
												...
												<c:otherwise>
													<c:forEach items="${list}" var="att" begin="1" end="35"
														varStatus="status">
														<tr class="Font8Pt" valign="top">
															<td height="21" class="RULine" align="center"
																valign="middle"
			...
			<tr>
				...
				<table width="40%" border="0" align="center" valign="middle"
					...
					<tr>
						...
						<td><a href="classfind_1.jsp" style='text-decoration:none;'>
