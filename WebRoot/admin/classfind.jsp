			...
			<section class="wrapper">
				...
				<section class="panel">
					...
					<div class="panel-body">
						<form action="Print_printFunction?page=scoreinput" method="post">
							...
							<button type="submit" class="btn btn-primary">非考察课成绩录入入口</button>
							<button type="submit" formaction="Print_printFunction?page=scorefkcinput" class="btn btn-primary">考察课成绩录入入口</button>
						</form>
				</section>
				<br>
				<br>
