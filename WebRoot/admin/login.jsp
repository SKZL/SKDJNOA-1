	...
	<DIV
		...
		<P style="padding: 30px 0px 10px; position: relative;">
			<SPAN class="u_logo"></SPAN> <INPUT class="ipt" id="uname"
				name="uname" type="text" value="" placeholder="请输入教师工号">
		<P style="position: relative;">
			<SPAN class="p_logo"></SPAN> <INPUT class="ipt" name="upwd"
				id="password" type="password" value="" placeholder="请输入登录密码">
		</P>

		<DIV
			style="height: 50px; line-height: 50px; margin-top: 30px; border-top-color: rgb(231, 231, 231); border-top-width: 1px; border-top-style: solid;">
			<span id="errorMessage"
				style="color: red;float: left;margin-left: 50px"></span> <SPAN
				style="float: right;"> <input id="loginBtn" type="submit"
				value="登录"
