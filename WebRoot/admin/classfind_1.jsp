...
<!-- END SHORTCUT ICON -->
<title>山东科技大学济南校区已录入课程及班级查询</title>
	...
	<section id="container" class="">
				...
				<section class="panel">
					...
					<div class="panel-body">
						<form action="Source_query?page=coursegradefinal" method="post">
							...
							<button type="submit" class="btn btn-primary">最终成绩单打印入口</button>
							<button type="submit" formaction="Source_query?page=courseandattendancegradefinal" class="btn btn-primary">平时成绩单打印入口</button>
						</form>
				</section>
				<br>
				<br>
		...
		<script type="text/javascript">
			function getKCM() {
				...
				var msg = "professional=" + professional + "&category=非公选";
